...
class DataRefresh {
    static void main(String[] args) {
        ...
        try {
            ...
            // Projections are only a forecast while the season has not started, and the league site
            // overwrites them once it has. See MflWeeklyScoresRefresh.
            new MflWeeklyScoresRefresh(year, 48571, 'api.myfantasyleague.com', ScoreKind.PROJECTED).run()
            ...
            new MflWeeklyScoresRefresh(year - 1, 48571, 'api.myfantasyleague.com', ScoreKind.ACTUAL).run()
